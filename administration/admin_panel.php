...
?>";
				...
				<div class='left' style='width: 35%;'>
				<label>{$lang['CONFIG_PLEWO']}: </label><input type='checkbox' name='panel_lewo'". ((!($config['panel_lewo'])) ? '' : ' checked=\'checked\'') . "><br><br>
				<label>{$lang['CONFIG_PPRAWO']}: </label><input type='checkbox' name='panel_prawo'". ((!($config['panel_prawo'])) ? '' : ' checked=\'checked\'') . "><br><br>
				<label>{$lang['CONFIG_PPOZIOMO']}: </label><input type='checkbox' name='panel_poziomo'". ((!($config['panel_poziomo'])) ? '' : ' checked=\'checked\'') . "><br><br>
